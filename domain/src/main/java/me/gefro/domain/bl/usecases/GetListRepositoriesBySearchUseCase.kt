...
class GetListRepositoriesBySearchUseCase(
    ...
    suspend fun execute(search: String, perPage: Int, page: Int): List<SearchRepositoriesItemDto>? = repositoriesRepository.getListBySearch(search = search, perPage = perPage, page = page)
